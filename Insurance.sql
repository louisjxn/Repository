...
-- Although this provides me with the information I need, I will display it in a more intuitive way using a pivot chart.
...
-- Now I will analyze how these charges break down by both smoker status and gender.
...
-- I want to create something easier to understand, so I will use a CASE to make a pivot chart that is easier to understand.
...
-- I will round two decimal places to make this easier to understand.
...
-- Male smokers incur 7.41% higher average charges than female smokers.
...
-- I modified the code to exlude the records where children is 4 or 5.
...
-- When those outliers are removed, we can see clearly that there is a positive correlation between number of children and average charges.
...
-- decreases, so to does average charges. 

-- It should be noted that there are only 20 individuals classified as "underweight". 


-- Next I wanted to dig deeper into the data and see how obesity breaks down by both BMI and smoker status.
...
-- Even though average charges vary across different age groups, it can still be seen clearly that average charges increase with age.
